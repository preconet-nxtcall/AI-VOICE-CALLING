  ...
  return (
    <div className="h-screen bg-slate-50 flex flex-col lg:grid lg:grid-cols-12 overflow-hidden relative font-sans">
      ...
      <div className="lg:col-span-5 flex items-center justify-center p-6 sm:p-10 h-full relative z-10 bg-white overflow-y-auto">
        <div className="w-full max-w-sm flex flex-col gap-6 my-auto py-4">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <h1 className="text-2xl font-black text-slate-900 tracking-tight font-heading leading-none">Create your account</h1>
            <p className="text-slate-500 text-xs mt-2 font-semibold">Get started with your 7-day free trial.</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4" noValidate>
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="reg-name" className="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest font-heading">
                Full Name
              </label>
            ...
            {/* Email */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="reg-email" className="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest font-heading">
                Email Address
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            {/* Password */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="reg-password" className="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest font-heading">
                Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
              ...
              {password && (
                <ul className="mt-1.5 space-y-1 pl-1">
                  {RULES.map((rule) => {
                    ...
                    return (
                      <li key={rule.id} className={`flex items-center gap-1.5 text-[10px] font-bold ${ok ? 'text-emerald-600 dark:text-emerald-500' : 'text-slate-450'}`}>
                        {ok
            ...
            {/* Confirm Password */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="reg-confirm" className="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest font-heading">
                Confirm Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                ...
                <input
                  ...
                  className={`w-full bg-slate-50 border rounded-xl py-2.5 !pl-11 !pr-10 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 transition-all font-semibold text-xs ${
                    confirmPassword && !passwordsMatch
                      ? 'border-red-500/65 focus:border-red-500 focus:ring-red-500'
                      : confirmPassword && passwordsMatch
                      ? 'border-emerald-500/65 focus:border-emerald-500 focus:ring-emerald-500'
              ...
              {confirmPassword && !passwordsMatch && (
                <p className="text-red-500 text-[10px] mt-1 pl-1 font-bold">Passwords do not match.</p>
              )}
              {confirmPassword && passwordsMatch && (
                <p className="text-emerald-600 text-[10px] mt-1 pl-1 flex items-center gap-1 font-bold">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-550 hover:to-indigo-650 text-white rounded-xl py-3 font-bold transition-all shadow-lg shadow-indigo-500/10 flex items-center justify-center gap-2 group mt-4 cursor-pointer text-xs"
            >
              {isLoading ? (
                <>
